						...
						<?php $mvp_slider = get_option('mvp_slider'); $mvp_posts = get_option('mvp_featured_posts'); if (($mvp_slider == "true") || ($mvp_posts == "true")) { ?>
							...
							<li class="infinite-post">
								...
								<div class="home-list-img">
									...
									<?php endif; ?>
									<span class="widget-cat-contain"><h3 class="widget-cat"><?php $category = get_the_terms( $post->ID, 'incsub_wiki_category' ); print_r($category); echo $category[2]->slug; ?></h3></span>
								</div><!--home-list-img-->
